...
{
	SYNC_TYPE_PACK = 0,                   //fake
	SYNC_TYPE_CREATE = 1,
	SYNC_TYPE_SYNC = 2,
	SYNC_TYPE_REMOVE = 3,
	SYNC_TYPE_TAKEOVER = 4,
	SYNC_TYPE_TIMESTAMP = 5,
	SYNC_TYPE_NETWORK = 6,                //fake
	SYNC_TYPE_END = 7,
};
...
enum INFINITE_AMMO_TYPE : uint32_t
{
	DISABLE,
	UNLIMITED_AMMO,
	UNLIMITED_CLIP,
...
enum CayoPericoHeistBitsetZero : uint32_t
{
	Kosatka = 0x000003,
	Velum = 0x000009,
	PatrolBoat = 0x000021,
...
enum CayoPericoIsland : uint32_t
{
	island_a = (1 << 1) - 1,
	island_b = (1 << 2) - 1,
	island_c = (1 << 3) - 1,
...
enum CayoPericoCompound : uint32_t
{
	compound_a = (1 << 1) - 1,
	compound_b = (1 << 2) - 1,
	compound_c = (1 << 3) - 1,
...
enum LocalAppendageType
{
	LocalAppendageType_At,
	LocalAppendageType_ReadGlobal,
...
{
	CEO_BAN = 1240068495,//joaat("mpply_vipgameplaydisabledtimer")
	CEO_KICK = -1425016400,//GBTER_BIG
	NOTIFICATION = -1529596656,
	SEND_TO_MISSION_1 = -1908874529,//TICK_PH_INV
	SEND_TO_MISSION_2 = -283041276,//FMMC_PLYLOAD
	TELEPORT_APARTMENT = -1390976345, //Mission_Pass_Notify
	PHONE_INVITE = 1111927333, //CELL_APTINVYACHT
	TRANSACTION_ERROR = -768108950,//PIM_TIGC
	ROTATE_CAM = -1388926377,
	PHONE_NOTIFICATION_1 = -382461133,//TICK_BC_ON
	PHONE_NOTIFICATION_2 = -923087411, //TICK_BC_OFF
	SPECTATE_MESSAGE = -2131157870, //SPEC_TCK1
	CLEAR_WANTED = 1449852136, //PLYVEH_INS_DES v
	BRIBE_AUTHORITY = -2095232746, //GB_BCUT_TICK0 v
	OFF_RADAR = -1973627888, //PLYVEH_INS_DES vl
	TELEPORT_CAYO = 1361475530, //CELL_HI_INV
	VEHICLE_KICK = -714268990, //PIM_RFMOC /PIM_RFAVE/PIM_EMVTK
	FAKE_MONEY = -1529596656, //TICK_ATTVAN / R2P_ACCT / R2P_JOINT
	FAKE_REMOVE = -290070531, //TICK_TC_REMO
	FAKE_BANKED = -849958015, //TICK_TC_BANK
	FAKE_STEAL = -1640162684, //TICK_TC_STOL
	...
	KICK_37 = -35026843, //Var11.f_2 = Var1.f_2;
	KICK_38 = -320008018, //Var0.f_3 = { *iParam2 };
	KICK_39 = 1672674814, //Var0.f_2[iVar14] = (*iParam1)[iVar14];
	KICK_40 = 1781594056,
	KICK_41 = -66669983,
	KICK_42 = -1501830047,
	...
	KICK_55 = 526822748, //if (NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()) == Var0.f_3[iVar10])
	KICK_56 = -555356783, //if (NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()) == Var0.f_3[iVar37])
