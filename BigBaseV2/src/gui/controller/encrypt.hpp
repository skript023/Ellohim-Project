...
namespace big::encryptor
{
    std::string encrypt(std::string& msg, std::string& key) {
        std::string b64_str = vigenere::base64_encode(msg);
    ...
    std::string decrypt(std::string& encrypted_msg, std::string& key) {
        ...
        std::string b64_encoded_str = vigenere::decrypt_vigenere(encrypted_msg, newKey);
        std::string b64_decode_str = vigenere::base64_decode(b64_encoded_str);
