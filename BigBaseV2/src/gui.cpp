	...
	void gui::script_on_tick()
	{
		TRY_CLAUSE
		{
			if (g_gui.m_opened)
			{
				...
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_AIM, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_VEH_ATTACK2, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_ATTACK2, TRUE);
				...
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_FRONTEND_PAUSE, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_FRONTEND_PAUSE_ALTERNATE, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_FRONTEND_ACCEPT, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_FRONTEND_CANCEL, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_MP_TEXT_CHAT_ALL, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_MP_TEXT_CHAT_TEAM, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_NEXT_CAMERA, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_LOOK_BEHIND, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_VEH_FLY_ATTACK_CAMERA, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_CURSOR_ACCEPT, TRUE);
				PAD::DISABLE_CONTROL_ACTION(2, INPUT_INTERACTION_MENU, TRUE);
